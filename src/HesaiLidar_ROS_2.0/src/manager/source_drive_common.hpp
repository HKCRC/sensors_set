...
public:
    ...
    bool GetDriveYamlParam(const YAML::Node& config, DriverParam &driver_param)
    {
        ...
        // AT128P single-return per-block timestamp options (nanoseconds)
        YamlRead<bool>(       driver_config, "at128p_block_ts_enable",            driver_param.decoder_param.at128p_block_ts_enable, false);
        YamlRead<int64_t>(    driver_config, "at128p_block_base_offset_ns",       driver_param.decoder_param.at128p_block_base_offset_ns, 9249);
        YamlRead<int64_t>(    driver_config, "at128p_block_interval_ns",          driver_param.decoder_param.at128p_block_interval_ns, 41666);
        ...
        YamlRead<bool>(       config["ros"], "ros_send_custom_msg",        driver_param.input_param.send_custom_msg, false);
        YamlRead<std::string>(config["ros"], "ros_send_custom_msg_topic",  driver_param.input_param.ros_send_custom_msg_topic, "custom_points");
        YamlRead<std::string>(config["ros"], "custom_msg_dump_path",       driver_param.input_param.custom_msg_dump_path, "");
        YamlRead<std::string>(config["ros"], "packet_time_dump_path",      driver_param.input_param.packet_time_dump_path, "");
        ...
        // async verifier options (ROS1)
        YamlRead<bool>(       config["ros"], "ros_verify_enable",                 driver_param.input_param.ros_verify_enable, false);
        YamlRead<bool>(       config["ros"], "ros_verify_only_at128p_single",     driver_param.input_param.ros_verify_only_at128p_single, true);
        return true;
    }
